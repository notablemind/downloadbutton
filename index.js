...
var DownloadButton = React.createClass({
    ...
    getDefaultProps: function() {
        return {async: false, downloadTitle: 'Download', generateTitle: 'Generate file', loadingTitle: 'Loading...'}
    },

    getInitialState: function() {
        return {loading: false, fileData: null}
    },
    ...
    _onDownload: function() {
        var fileData = this.props.fileData || (this.props.async
                ? this.state.fileData
                : this.props.genFile())
            if (!fileData) {
                return false
